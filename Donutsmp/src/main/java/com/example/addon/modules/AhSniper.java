...
public class AhSniper extends Module {
    ...
    private final Setting<String> maxPrice = sgGeneral.add(new StringSetting.Builder()
        .name("max-price")
        .description("Max Price To Pay Like ( K, M, B. )")
        .defaultValue("69")
        .build()
    );
    ...
    private final Setting<Integer> refreshDelay = sgGeneral.add(new IntSetting.Builder()
        .name("refresh-delay")
        .description("Delay Between Auction Page Refresh")
        .defaultValue(2)
        .min(0)
        .max(100)
        .sliderMax(20)
    ...
    private final Setting<Integer> buyDelay = sgGeneral.add(new IntSetting.Builder()
        .name("buy-delay")
        .description("Delay Between Buy Item.")
        .defaultValue(2)
        .min(0)
        .max(100)
        .sliderMax(20)
    ...
    public AhSniper() {
        super(AddonTemplate.CATEGORY, "AhSniper", "Made By Fangs/GEC OWNER");
    }
    ...
    public void onActivate() {
        ...
        if (snipingItem.get() == Items.AIR) {
            if (notifications.get()) {
                ChatUtils.error("Please Select Item To Buy");
            }
            toggle();
            return;
        }
