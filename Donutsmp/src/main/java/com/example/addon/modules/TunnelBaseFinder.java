...
public class TunnelBaseFinder extends Module {
    ...
    public TunnelBaseFinder() {
        super(com.example.addon.AddonTemplate.CATEGORY, "TunnelBaseFinder", "Made By Fangs/GEC OWNER");
    }
    ...
    private void sendBaseFindWebhook(StashChunk chunk) {
        try {
            ...
            String jsonPayload = String.format("""
                {
                  "username": "Fangs BaseFinder",
                  "avatar_url": "https://i.imgur.com/FGrUip6.png",
                  "embeds": [
                    {
                      "title": "Base Founded",
                      "description": "%s",
